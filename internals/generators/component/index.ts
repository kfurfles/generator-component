...
import { camelize, pathExists } from '../utils';
...
export const componentGenerator: PlopGeneratorConfig = {
  ...
  actions: data => {
    ...
    // const componentNameCamelCase = camelize(ComponentProptNames.componentName);
    ...
    const actions: Actions = [
      {
        type: 'add',
        path: `${componentPath}/{{camelCase ${ComponentProptNames.componentName}}}.component.tsx`,
